...
Viva Engage supports a Publisher information bar for users that belong to an [information barriers segment](/purview/information-barriers-policies#identify-segments). Users who compose new posts or post replies receive reminders that their content is visible to every user of their network. To enable this feature for your Viva Engage network, you must [file a request in Microsoft Purview](/purview/purview-portal).

[Microsoft Purview Information Barriers](/purview/information-barriers) (IB) is a compliance feature to limit two-way communication and collaboration between certain groups and users in various Microsoft apps. Businesses in highly regulated sectors widely use this capability to observe compliance requirements, and it's suitable for all organizations that need to prevent information leakage. IBs help to avoid conflicts of interest and safeguard internal information between users and organizational areas.
